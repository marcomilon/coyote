...
export const FONT_PAIRINGS = {
  ...
  'syne-manrope': pairing('Syne', 'sans-serif', 800, 'Syne:wght@800', 'Manrope', 'sans-serif', 'Manrope:wght@400;600', 'poster'),
  'publicsans-publicsans': pairing('Public Sans', 'sans-serif', 700, 'Public+Sans:wght@400;600;700', 'Public Sans', 'sans-serif', 'Public+Sans:wght@400;600;700', 'sans'),
